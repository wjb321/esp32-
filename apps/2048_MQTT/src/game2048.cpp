...
void game_2048_process(AppSwitch *sys, const MQTT_Action *act_info)
{
...
APP_OBJ game_2048_app1 = {"EscapeRoom", &EscapeRoom, "", NULL, NULL, NULL};//,game_2048_event_notification 
