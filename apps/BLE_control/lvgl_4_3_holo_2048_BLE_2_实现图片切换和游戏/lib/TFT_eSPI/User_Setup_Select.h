...
#define PIN_D3   15  // GPIO0        Low on boot means enter FLASH mode
#define PIN_D4   -1 // GPIO2        TXD1 (must be high on boot to go to UART0 FLASH mode)
#define PIN_D5  14  // GPIO14       HSCLK
#define PIN_D6  12  // GPIO12       HMISO
#define PIN_D7  13  // GPIO13       HMOSI  RXD2
#define PIN_D8  12  // GPIO15       HCS    TXD0 (must be low on boot to enter UART0 FLASH mode)
